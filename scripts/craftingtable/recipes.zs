...
recipes.addShaped(<techguns:t4_power_boots>, [[<techguns:t3_power_boots>, <ore:plateIridium>, <ore:gearEnderium>],[<ore:plateIridium>, <ore:plateIridium>, <techguns:itemshared:67>], [<ore:gearEnderium>, <techguns:itemshared:67>, <techguns:itemshared:67>]]);
recipes.addShaped(<techguns:t4_power_leggings>, [[<techguns:t3_power_leggings>, <ore:plateIridium>, <ore:gearEnderium>],[<ore:plateIridium>, <ore:plateIridium>, <techguns:itemshared:67>], [<ore:gearEnderium>, <techguns:itemshared:67>, <techguns:itemshared:67>]]);
recipes.addShaped(<techguns:t4_power_chestplate>, [[<techguns:t3_power_chestplate>, <ore:plateIridium>, <ore:gearEnderium>],[<ore:plateIridium>, <ore:plateIridium>, <techguns:itemshared:67>], [<ore:gearEnderium>, <techguns:itemshared:67>, <techguns:itemshared:67>]]);
recipes.addShaped(<techguns:t4_power_helmet>, [[<techguns:t3_power_helmet>, <ore:plateIridium>, <ore:gearEnderium>],[<ore:plateIridium>, <ore:plateIridium>, <techguns:itemshared:67>], [<ore:gearEnderium>, <techguns:itemshared:67>, <techguns:itemshared:67>]]);
